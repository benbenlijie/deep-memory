...
Before automation, keep the dashboard as `docs/research/METRICS.md` plus an optional CSV file such as `docs/metrics-weekly.csv`. Each weekly row should use this schema:
