...
Details: https://github.com/benbenlijie/deep-memory/blob/main/docs/COMPETITIVE_BENCHMARK.md

6/ Comparison, without fake scores:

| system | default shape | benchmark status |
| --- | --- | --- |
| deep-memory | local SQLite | measured locally |
| mem0 | OSS + provider/backend setup | blocked here |
| Zep | cloud-first service | blocked here |
| LangMem | LangGraph ecosystem | blocked here |

If I cannot reproduce it locally, I do not report a number.

7/ The trust system matters.
...
8/ Bi-temporal / lifecycle direction:
...
9/ Cross-agent is the core use case.
...
10/ Chinese retrieval is first-class.
...
11/ This is alpha, and intentionally a controlled preview.
...
12/ GitHub: https://github.com/benbenlijie/deep-memory
